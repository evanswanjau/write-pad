...
function getProfilePic($path=''){
  ...
  $sql = "SELECT image FROM user WHERE user_id = 1";
  $result = $conn->query($sql);
  ...
  if($result->num_rows > 0){
    ...
    $value = "<img src='".$path."image-backgrounds/$image' alt='profile pic'>";
  }else {
    $value = "<img src='".$path."image-backgrounds/default.png' alt='profile pic'>";
  }
    ...
    if ($_POST['old-password'] == '') {
      ...
      if (password_verify($oldpassword, $dbpassword)) {
        ...
        if ($_POST['new-password'] == '') {
          ...
          $newpassword = clean_data($_POST['new-password']);
          if (strlen($newpassword) < 6) {
            ...
            if ($_POST['confirm-password'] == '') {
              ...
              $confirmpassword = clean_data($_POST['confirm-password']);
